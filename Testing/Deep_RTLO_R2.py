...
class RTLO:
    def __init__(self, nI, nR, nO, ηS=[0.1, 0.1, 0.1], τ=10, mode='past', act='tanh'):
        ...
        # Garante que nR seja uma lista de tamanhos (ex: [64, 32] ou 32)
        ...
        # Estados ocultos alocados com o tamanho de cada camada específica
        ...
        # Matrizes de traço ajustadas às dimensões das conexões
